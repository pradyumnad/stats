...
public class CopyOfStatistics {
	...
	public static class Reduce extends
		...
		public void reduce(Text key, Iterable<IntWritable> values,
			...
			} else if (command.equalsIgnoreCase(kSD)) {

			}
		}

		private float percentile(List<IntWritable> values, float count, int type) {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(CopyOfStatistics.class);
